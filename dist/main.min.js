(function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
        ...
        function view(calculatorVDom) {
            return calculatorVDom.map(function(calcVNode) {
                return dom_1.div(".app", [dom_1.h1(".title.", ""), calcVNode, dom_1.h2(".footnote." + styles_1.default.footnote, [dom_1.a({
                    attrs: {
                        href: "https://github.com/staltz/matrixmultiplication.xyz"
                    }
                }, "")])])
            })
        }
    ...
    2: [function(require, module, exports) {
        ...
        (function(Styles) {
            Styles.title = typestyle_1.style({
                ...
                paddingBottom: "3rem",
                zIndex: 10,
                backgroundImage: "linear-gradient(to bottom, " + "white 0, " + "rgba(255,255,255,0.9) 60%, " + "rgba(255,255,255,0) 100%)"
            });
    ...
    7: [function(require, module, exports) {
        ...
        "xstream/extra/delay": 153,
        "xstream/extra/dropRepeats": 154
    }],
    ...
    9: [function(require, module, exports) {
        ...
        var defaultState = {
            ...
            matrixA: {
                values: MatrixValues_1.default.from([
                    [1, 2, 1],
                    [0, 1, 0],
                    [2, 3, 4]
                ]),
        ...
        "../../utils/MatrixValues": 35,
        "./reducers/controlPanel": 11,
        "./reducers/measure": 12,
        "./reducers/resize": 13,
        "./reducers/timers": 14,
        xstream: 156
    ...
    10: [function(require, module, exports) {
        ...
        function isInCombStep(state) {
            return (state.step === 1 && state.canInteract || state.step > 1) && state.step <= lastCombStep(state)
        }
    ...
    11: [function(require, module, exports) {
        ...
        function startMultiplyReducer$(action$) {
            return action$.map(function() {
                return function startMultiplyReducer(prevState) {
                    if (prevState.step === 0) {
                        return {
                            step: 1,
                            canInteract: false,
        ...
        function nextStepReducer$(action$) {
            return action$.map(function() {
                return function nextStepReducer(prevState) {
        ...
        function resetReducer$(action$) {
            return action$.map(function() {
                return function resetReducer(prevState) {
                    return {
                        step: 0,
                        canInteract: true,
                        fastForwardToEnd: false,
    ...
    12: [function(require, module, exports) {
        ...
        function updateMeasurementsReducer$(measurements$) {
            return measurements$.map(function(measurements) {
    ...
    13: [function(require, module, exports) {
        ...
        function resizeReducer$(action$) {
            return action$.map(function(action) {
                return function resizeReducer(prevState) {
    ...
    15: [function(require, module, exports) {
        ...
        (function(Styles) {
            ...
            Styles.step1Duration1 = 600;
            Styles.step1Duration2 = 900;
            Styles.nextCombDuration = 500;
            Styles.nextCombCellTransitionDelay = Styles.nextCombDuration * .5;
            Styles.colorPallete = styles_2.pallete;
            Styles.cellScaleWhenIntersecting = .55;
            Styles.cellTranslateXWhenIntersecting = 16;
            Styles.cellTranslateYWhenIntersecting = 10;
            Styles.finalResultDuration = 1100;
            Styles.finalFadeDuration = Styles.finalResultDuration * .8;
    ...
    16: [function(require, module, exports) {
        ...
        function timers(state$) {
            var stateChange$ = state$.compose(dropRepeats_1.default(function(s1, s2) {
                return s1.step === s2.step && s1.canInteract === s2.canInteract
            }));
            var allowContinueFromStartMultiply$ = stateChange$.filter(function(state) {
                return state.step === 1 && !state.canInteract
            }).compose(delay_1.default(styles_1.default.step1Duration1 + styles_1.default.step1Duration2)).mapTo(null);
            var allowContinueFromNextComb$ = stateChange$.filter(function(state) {
                return queries_1.isInCombStep(state) && !state.canInteract
            }).compose(delay_1.default(styles_1.default.nextCombDuration)).mapTo(null);
            var allowContinueFromEnd$ = stateChange$.filter(function(state) {
                return state.step === queries_1.lastCombStep(state) + 1 && !state.canInteract
            }).compose(delay_1.default(styles_1.default.finalResultDuration)).mapTo(null);
    ...
    17: [function(require, module, exports) {
        ...
        function renderRowsResizer(id) {
            return dom_1.div(".rowsResizer." + styles_1.default.rowsResizer, [dom_1.div(".decreaseRow" + id + "." + styles_1.default.resizerButton, "-"), dom_1.div(".increaseRow" + id + "." + styles_1.default.resizerButton, "+")])
        }
        exports.renderRowsResizer = renderRowsResizer;

        function renderColsResizer(id) {
            return dom_1.div(".colsResizer." + styles_1.default.colsResizer, [dom_1.div(".decreaseCol" + id + "." + styles_1.default.resizerButton, "-"), dom_1.div(".increaseCol" + id + "." + styles_1.default.resizerButton, "+")])
        }
    ...
    18: [function(require, module, exports) {
        ...
        function getArrayOfButtons(state) {
            ...
            var buttons = [];
            if (step === 0) {
                buttons = [dom_1.div(".multiply." + styles_1.default.multiplyButton, [play_1.default, "Zmnoži"])]
            } else if (step === 1 && !state.canInteract) {
                buttons = [dom_1.div(".multiply." + styles_1.default.multiplyButtonDisabled, [play_1.default, "Zmnoži"])]
            } else if (step >= 1 && step <= queries_1.lastCombStep(state) && state.canInteract) {
                buttons = [dom_1.div(".next." + styles_1.default.nextButton, [next_1.default, "Naprej"]), dom_1.div(".end." + styles_1.default.endButton, [end_1.default, "Konec"])]
            } else if (step >= 1 && step <= queries_1.lastCombStep(state) + 1 && !state.canInteract) {
                buttons = [dom_1.div(".next." + styles_1.default.nextButtonDisabled, [next_1.default, "Naprej"]), dom_1.div(".end." + styles_1.default.endButtonDisabled, [end_1.default, "Konec"])]
            } else if (step === queries_1.lastCombStep(state) + 1 && state.canInteract) {
                buttons = [dom_1.div(".reset." + styles_1.default.resetButton, [reset_1.default, "Ponovi"])]
            }
            return buttons
        }
    ...
    19: [function(require, module, exports) {
        ...
        function maybeRenderEqualsSign(state) {
            ...
            return dom_1.span(".resultEqualsSign." + styles_1.default.resultEqualsSign, {
                style: style
            }, "=")
        }
        ...
        function view(state$, vdomA$, vdomB$, vdomC$) {
            ...
            return xstream_1.default.combine(state$, transform$, vdomA$, vdomB$, vdomC$.startWith(null)).map(function(_a) {
                var state = _a[0],
                    transform = _a[1],
                    matrixA = _a[2],
                    matrixB = _a[3],
                    matrixC = _a[4];
                return dom_1.div(".calculator." + styles_1.default.calculator, [dom_1.div(".matrices." + styles_1.default.matrices, [matrixA_1.renderMatrixA(matrixA, state), renderSign(state), matrixB_1.renderMatrixB(matrixB, state, transform), maybeRenderEqualsSign(state), matrixC_1.maybeRenderMatrixC(matrixC, state)]), controlPanel_1.renderControlPanel(state)])
            })
        }
        Object.defineProperty(exports, "__esModule", {
            value: true
    ...
    20: [function(require, module, exports) {
        ...
        function renderOperatorGrid(state) {
            ...
            return dom_1.div(".operatorGrid." + styles_2.default.operatorGrid, rows.map(function(row, i) {
                ...
                return dom_1.ul("." + styles_1.default.row, row.map(function(cellVal, j) {
                    ...
                    return dom_1.li([dom_1.span(".operator", {
                        class: (_a = {}, _a[styles_1.default.cell] = true, _a[styles_2.default.operatorCell] = true, _a[styles_2.default.plusSign] = shouldShowPlus, _a),
                        style: {
                            opacity: shouldShowMultiply ? 1 : .01
                        }
            ...
            return function updateHook(prev, next) {
                ...
                var _loop_1 = function(i, N) {
                    ...
                    if (queries_1.isInCombStep(state)) {
                        ...
                        setTimeout(function() {
                            return cellElem.classList.remove(styles_2.default.animatedCell)
                        }, styles_2.default.nextCombDuration)
                    }
        ...
        function renderMatrixA(matrixA, state) {
            ...
            return dom_1.table(".matrixAWrapper." + styles_2.default.matrixWrapperTable, [dom_1.tr([dom_1.td(showResizers ? [common_1.renderRowsResizer("A")] : []), dom_1.td(".matrixA." + styles_2.default.matrixA, {
                hook: {
                    update: mutateCellStyles(state)
                }
            }, [matrixA, renderOperatorGrid(state)])]), dom_1.tr([dom_1.td(), dom_1.td(".colsResizerContainer." + styles_2.default.colsResizerContainer, showResizers ? [common_1.renderColsResizer("A")] : [])])])
        }
    ...
    21: [function(require, module, exports) {
        ...
        function mutateCellStyles(state, transform) {
            ...
            var rotateZTransform = transform.split(" ").filter(function(t) {
                return t.match(/^rotateZ/) !== null
            }).pop().replace("-", "+").trim();
            return function updateHook(prev, next) {
                var all = next.elm.querySelectorAll(".cell");
                for (var i = 0, N = all.length; i < N; i++) {
        ...
        function renderMatrixB(matrixB, state, transform) {
            ...
            return dom_1.table(".matrixBWrapper." + styles_1.default.matrixWrapperTable, [dom_1.tr([dom_1.td(".matrixB." + styles_1.default.matrixB, {
                style: {
                    opacity: opacity,
                    transform: transform,
                ...
                hook: {
                    update: mutateCellStyles(state, transform)
                }
            }, [matrixB]), dom_1.td(showResizers ? [common_1.renderRowsResizer("B")] : [])]), dom_1.tr([dom_1.td(".colsResizerContainer." + styles_1.default.colsResizerContainer, showResizers ? [common_1.renderColsResizer("B")] : []), dom_1.td()])])
        }
    ...
    22: [function(require, module, exports) {
        ...
        function maybeRenderMatrixC(matrixC, state) {
            ...
            if (matrixC === null || step === 0 || step === 1 && !state.canInteract) {
                ...
                var yDist = state.measurements.matrixAHeight * .5;
                return dom_1.div(".matrixC", {
    ...
    23: [function(require, module, exports) {
        ...
        function makeStartMultiplyTransform$(state$) {
            return state$.filter(function(state) {
                ...
                var yLift = padding + state.measurements.matrixAHeight * .5 + state.measurements.matrixBHeight * .5;
                return concat_1.default(tween_1.default({
                    from: 0,
                    to: yLift,
                    duration: styles_1.default.step1Duration1,
                    ease: ease
                }).map(function(y) {
                    return "\n            translateX(0%)\n            translateY(" + -y + "px)\n            rotateZ(0deg)\n          "
                }), tween_1.default({
                    from: 0,
                    to: 1,
                    duration: styles_1.default.step1Duration2,
                    ease: ease
                }).map(function(t) {
        ...
        function makeNextStepTransform$(state$) {
            return state$.filter(function(state) {
                return state.step > 1 && state.step <= queries_1.lastCombStep(state)
            }).map(function(state) {
                var ease = tween_1.default.power2.easeInOut;
                var duration = styles_1.default.nextCombDuration;
                var yLift = padding + state.measurements.matrixAHeight * .5 + state.measurements.matrixBHeight * .5;
                var yPrev = state.step === 2 ? yLift : yLift - padding - styles_1.default.matrixBracketWidth * 2 - state.measurements.rowHeight * (state.step - 2);
                var yNext = yLift - padding - styles_1.default.matrixBracketWidth * 2 - state.measurements.rowHeight * (state.step - 1);
                return tween_1.default({
                    from: yPrev,
                    to: yNext,
                    duration: duration,
                    ease: ease
        ...
        function makeEndTransform$(state$) {
            return state$.filter(function(state) {
                return state.step === queries_1.lastCombStep(state) + 1
            }).map(function(state) {
                var ease = tween_1.default.power2.easeInOut;
                var duration = styles_1.default.finalFadeDuration;
                var timeToReset = styles_1.default.finalResultDuration - duration;
                var yLift = padding + state.measurements.matrixAHeight * .5 + state.measurements.matrixBHeight * .5;
                var yLastComb = yLift - padding - styles_1.default.matrixBracketWidth * 2 - state.measurements.rowHeight * (state.step - 2);
                var yOutside = yLastComb - state.measurements.rowHeight - padding * 4;
                return concat_1.default(tween_1.default({
                    from: yLastComb,
                    to: yOutside,
                    duration: duration,
                    ...
                    return "\n          translateX(" + -xMove + "px)\n          translateY(" + -y + "px)\n          rotateZ(-90deg)\n        "
                }), xstream_1.default.of("translateX(0px) translateY(0px) rotateZ(0deg)").compose(delay_1.default(timeToReset * .9)))
            }).flatten()
        }

        function makeTransform$(state$) {
            var stateOnStepChange$ = state$.compose(dropRepeats_1.default(function(s1, s2) {
        ...
        "../styles": 15,
        xstream: 156,
        "xstream/extra/concat": 152,
        "xstream/extra/delay": 153,
        "xstream/extra/dropRepeats": 154,
        "xstream/extra/tween": 155
    }],
    ...
    25: [function(require, module, exports) {
        ...
        function intent(domSource) {
            return domSource.select(".cell").events("input").map(function(ev) {
    ...
    26: [function(require, module, exports) {
        ...
        var defaultState = {
            ...
            editable: true,
            id: "matrix" + Math.round(Math.random() * 1e3)
        };
        ...
        function model(action$) {
            ...
            var inputReducer$ = action$.map(function(action) {
                return function inputReducer(prevState) {
                    return {
    ...
    28: [function(require, module, exports) {
        ...
        function renderAllCells(state) {
            return state.values.rows.map(function(row, i) {
                return dom_1.ul(".row." + styles_1.default.row, {
                    key: "row" + i
                }, row.map(function(cellValue, j) {
                    return dom_1.li(".col", {
                        key: "col" + j
                    }, [state.editable ? renderCellAsInput(cellValue, i, j) : renderCellAsSpan(cellValue, i, j)])
                }))
            })
        }
        ...
        function view(state$) {
            return state$.map(function(state) {
                return dom_1.div(".matrix." + styles_1.default.matrix, {
                    key: state.id
                }, [renderLeftBracket(state)].concat(renderAllCells(state), [renderRightBracket(state)]))
            })
        }
        Object.defineProperty(exports, "__esModule", {
            value: true
    ...
    35: [function(require, module, exports) {
        ...
        var MatrixValues = function() {
            ...
            MatrixValues.prototype.resize = function(numRows, numColumns) {
                var _a = this,
                    oldNumRows = _a.numRows,
                    oldNumCols = _a.numCols;
                var nR = Math.max(1, numRows);
                var nC = Math.max(1, numColumns);
                var mv = new MatrixValues;
                mv.numRows = nR;
                mv.numCols = nC;
                mv.values = this.values.setSize(nR).map(function(rows, rowIndex) {
    ...
    44: [function(require, module, exports) {
        ...
        "snabbdom-selector/lib/commonjs/classNameFromVNode": 123,
        "snabbdom-selector/lib/commonjs/selectorParser": 124,
        "snabbdom/h": 132
    }],
    ...
    49: [function(require, module, exports) {
        ...
        function makeDOMDriver(container, options) {
            ...
            function DOMDriver(vnode$, name) {
                ...
                }).fold(patch, tovnode_1.toVNode(rootElement)).drop(1).map(unwrapElementFromVNode).compose(dropCompletion).startWith(rootElement);
                var listener = {
    ...
    50: [function(require, module, exports) {
        ...
        var defaultModules = [modulesForHTML.attributes, modulesForHTML.props, modulesForHTML.class, modulesForHTML.style];
        var noop = function() {};
        ...
        "./HTMLSource": 40,
        "snabbdom-to-html/init": 126,
        "snabbdom-to-html/modules": 129
    }],
    ...
    53: [function(require, module, exports) {
        ...
        "snabbdom/modules/attributes": 135,
        "snabbdom/modules/class": 136,
        "snabbdom/modules/dataset": 137,
        "snabbdom/modules/props": 138,
        "snabbdom/modules/style": 139
    }],
    ...
    55: [function(require, module, exports) {
        ...
        function isolateAllSources(sources, scope) {
            ...
            for (var key in sources) {
                ...
                if (sources.hasOwnProperty(key) && source && typeof source.isolateSource === "function") {
        ...
        function isolateAllSinks(sources, sinks, scope) {
            ...
            for (var key in sinks) {
                var source = sources[key];
                if (sinks.hasOwnProperty(key) && source && typeof source.isolateSink === "function") {
    ...
    59: [function(require, module, exports) {
        ...
        function pick(selector) {
            if (typeof selector === "string") {
                return function pickWithString(sinksArray$) {
                    return sinksArray$.map(function(sinksArray) {
                        return sinksArray.map(function(sinks) {
                            return sinks[selector]
                        })
                    })
                }
            } else {
                return function pickWithFunction(sinksArray$) {
                    return sinksArray$.map(function(sinksArray) {
                        return sinksArray.map(selector)
                    })
                }
            }
        }
        ...
        function mix(aggregator) {
            return function mixOperator(streamArray$) {
                return streamArray$.map(function(streamArray) {
                    return aggregator.apply(void 0, streamArray)
                }).flatten()
            }
        }
        exports.mix = mix;
        ...
        var StateSource = function() {
            ...
            StateSource.prototype.select = function(scope) {
                return new StateSource(this.state$.map(function(s) {
                    return s[scope]
                }).filter(function(s) {
        ...
        function onionify(main, name) {
            ...
            return function augmentedMain(sources) {
                ...
                }, void 0).drop(1).compose(dropRepeats_1.default());
    ...
    60: [function(require, module, exports) {
        ...
        "es5-ext/object/copy": 74,
        "es5-ext/object/map": 82,
        "es5-ext/object/valid-callable": 88,
        "es5-ext/object/valid-value": 89
    }],
    61: [function(require, module, exports) {
        ...
        "es5-ext/object/assign": 71,
        "es5-ext/object/is-callable": 77,
        "es5-ext/object/normalize-options": 83,
        "es5-ext/string/#/contains": 90
    }],
    ...
    75: [function(require, module, exports) {
        ...
        "./set-prototype-of/is-implemented": 86,
        "./set-prototype-of/shim": 87
    }],
    ...
    94: [function(require, module, exports) {
        ...
        "./": 97,
        d: 61,
        "es5-ext/object/set-prototype-of": 85,
        "es5-ext/string/#/contains": 90
    }],
    95: [function(require, module, exports) {
        ...
        module.exports = function(iterable, cb) {
            var mode, thisArg = arguments[2],
                result, doBreak, broken, i, l, char, code;
        ...
        "./get": 96,
        "es5-ext/function/is-arguments": 64,
        "es5-ext/object/valid-callable": 88,
        "es5-ext/string/is-string": 93
    }],
    ...
    104: [function(require, module, exports) {
        ...
        "es5-ext/object/primitive-set": 84
    }],
    ...
    106: [function(require, module, exports) {
        ...
        "./is-native-implemented": 103,
        "./lib/iterator": 105,
        d: 61,
        "es5-ext/array/#/clear": 62,
        "es5-ext/array/#/e-index-of": 63,
        "es5-ext/object/set-prototype-of": 85,
        "es5-ext/object/valid-callable": 88,
        "es5-ext/object/valid-value": 89,
        "es6-iterator/for-of": 95,
        "es6-iterator/valid-iterable": 100,
        "es6-symbol": 107,
        "event-emitter": 112
    }],
    ...
    113: [function(require, module, exports) {
        (function(process) {
            ...
            function hyphenate(propertyName) {
                return propertyName.replace(/([A-Z])/g, "-$1").replace(/^ms-/, "-ms-").toLowerCase()
            }
    ...
    135: [function(require, module, exports) {
        ...
        function updateAttrs(oldVnode, vnode) {
            ...
            for (key in attrs) {
                ...
                old = oldAttrs[key];
                if (old !== cur) {
                    if (!cur && booleanAttrsDict[key]) elm.removeAttribute(key);
                    else {
                        namespaceSplit = key.split(":");
                        if (namespaceSplit.length > 1 && NamespaceURIs.hasOwnProperty(namespaceSplit[0])) elm.setAttributeNS(NamespaceURIs[namespaceSplit[0]], key, cur);
    ...
    147: [function(require, module, exports) {
        ...
        var ts = new typestyle_1.TypeStyle({
        ...
        function createTypeStyle(target) {
            var instance = new typestyle_1.TypeStyle({
        ...
        "./internal/typestyle": 149,
        "./internal/utilities": 150,
        "./types": 151
    }],
        ...
        var TypeStyle = function() {
            function TypeStyle(_a) {
                ...
                this.keyframes = function(frames) {
                    var _a = formatting_1.explodeKeyframes(frames),
                ...
                this.style = function() {
                    ...
                    var freeStyle = _this._freeStyle;
                    var _a = formatting_1.ensureStringObj(utilities_1.extend.apply(void 0, objects)),
                        result = _a.result,
                        debugName = _a.debugName;
    ...
    155: [function(require, module, exports) {
        ...
        function createEasing(fn) {
            ...
            return {
                ...
                easeInOut: function(x, from, to) {
                    var y = x < .5 ? fn(2 * x) * .5 : .5 + fnFlipped(2 * (x - .5)) * .5;
        ...
        function easeOutFn(x) {
            ...
            if (z < 1 / PARAM2) {
                ...
                return PARAM1 * (z -= 1.5 / PARAM2) * z + .75
            } else if (z < 2.5 / PARAM2) {
                return PARAM1 * (z -= 2.25 / PARAM2) * z + .9375
            } else {
                return PARAM1 * (z -= 2.625 / PARAM2) * z + .984375
            }
        }
        ...
        function tween(_a) {
            ...
            return index_1.Stream.periodic(interval).take(totalTicks).map(function(tick) {
                return ease(tick / totalTicks, from, to)
            }).compose(function(s) {
                return concat_1.default(s, index_1.Stream.of(to))
            })
        }
    ...
    156: [function(require, module, exports) {
        ...
        var Stream = function() {
            ...
            Stream.createWithMemory = function(producer) {
                if (producer) internalizeProducer(producer);
            ...
            Stream.from = function(input) {
                if (typeof input[symbol_observable_1.default] === "function") return Stream.fromObservable(input);
            ...
            Stream.prototype._map = function(project) {
                var p = this._prod;
                var ctor = this.ctor();
                if (p instanceof Filter) return new ctor(new FilterMapFusion(p.f, project, p.ins));
